    ...
    public static void main(String[] args) {
        ...
        if (canal != null)  //Si hemos podido establecer la conexión. Tenemos
            ...
            try{
               ...
               procesoComando2 = builder.exec(cmd);
             //Escribir en la escucha del proceso
               OutputStream os = procesoComando2.getOutputStream();
               OutputStreamWriter osw = new OutputStreamWriter(os);
               PrintWriter pw = new PrintWriter(osw);
               while ((linea = entrada.readLine()) != null){
            	   pw.write(linea); //Mandamos del 0 al 9
               } 
               pw.close();
               
               
               BufferedReader bf = new BufferedReader(new InputStreamReader(procesoComando2.getInputStream()));
               
               
               while ((linea = bf.readLine()) != null){
                   System.out.println(linea); //Mandamos del 0 al 9
               }                
            }catch (Exception ex){
               System.err.println("No se ha podido establecer conexión.");
               System.err.println(ex.toString());
